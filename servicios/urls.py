...
from . import views
from .views import Formulario_de_estadistica, Formulario_clientes_db

urlpatterns = [
   
    path('',views.servicios, name="Servicios"),
    path('probar/<int:servicio_id>/',views.probar, name="probar"),
    path('cliente_db/',Formulario_clientes_db.as_view(), name="cliente_db"),
    ...
    path("mostrar_datos_db/<int:archivo_id>/<separador>/", views.mostrar_datos_db, name="mostrar_datos_db"),
